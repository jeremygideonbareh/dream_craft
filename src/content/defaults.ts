...
export const defaults = {
  ...
  products: [
    {
      ...
      images: ['asset:wedding-card-nr.jpg', 'asset:birthday-invite-fairy.jpg', 'asset:birthday-invite-woodland.jpg'],
      variants: [],
    ...
    },
    {
      ...
      images: ['asset:bouquet-blush-peony.webp', 'asset:bouquet-terracotta.jpg', 'asset:bouquet-tulip.jpg', 'asset:bouquet-red-brooch.jpg'],
    ...
    },
    {
      ...
      images: ['asset:boutonniere-succulent.webp', 'asset:boutonnieres-ivory.jpg', 'asset:boutonnieres-dried.jpg'],
      variants: [{ value: 'artificial', label: 'Artificial flowers', note: '' }, { value: 'dried', label: 'Natural dried flowers', note: '' }],
    ...
    },
    {
      ...
      unit: 'piñatas', defaultQty: 1, estimate: false, images: ['asset:pinata-dinosaur.webp'], variants: [], shapes: [], materials: [],
    ...
    },
    {
      ...
      unit: 'pieces', defaultQty: 10, estimate: false, images: ['asset:prop-astronaut-number.jpg'], variants: [], sizes: [], shapes: [], finishes: [],
    ...
    },
    {
      ...
      images: ['asset:ring-holder-swing.webp', 'asset:ring-holder-oval.jpg', 'asset:ring-holder-round.jpg'],
  ...
  gallery: [
    { id: 'blush-peony', visible: true, image: 'asset:bouquet-blush-peony.webp', product: 'bouquets', title: 'Blush peony', alt: 'Blush and mauve peony bridal bouquet with white roses and eucalyptus, tied with ivory ribbon' },
    { id: 'swing-wreath', visible: true, image: 'asset:ring-holder-swing.webp', product: 'ring-holders', title: 'Swing wreath', alt: 'Dried flower wreath ring holder with a tiny swing, on an engraved wooden slice' },
    { id: 'astronaut-one', visible: true, image: 'asset:prop-astronaut-number.jpg', product: 'props', title: 'Little astronaut', alt: 'Number one first birthday prop with an astronaut, rocket, stars and a gold name topper' },
    { id: 'dino-pinata', visible: true, image: 'asset:pinata-dinosaur.webp', product: 'pinata', title: 'Dino piñata', alt: 'Blue and purple fringed dinosaur piñata hanging in a garden' },
    { id: 'succulent', visible: true, image: 'asset:boutonniere-succulent.webp', product: 'boutonnieres', title: 'Succulent & lavender', alt: 'Succulent boutonniere with lavender and a twine-wrapped stem on a navy suit lapel' },
    ...
    { id: 'woodland-fox', visible: true, image: 'asset:birthday-invite-woodland.jpg', product: 'invitations', title: 'Woodland fox', alt: 'Woodland fox birthday invitation in a clear box with a green satin ribbon' },
